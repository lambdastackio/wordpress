...
* Added by Ted
* functions to populate template and format
* suppress error customCallbackFunction is not a function 
* although no error on the result
*********************************************************************/
...
function populateTpl(tweets){
  var element = document.getElementById('tdv-tweet');
